def cifrar(texto, desplazamiento):
    ...
    for letra in texto:
        if letra != " ":
            numero_de_letra = ord(letra) - ord("a")
            numero_de_letra = (numero_de_letra + desplazamiento) % 26
            letra_del_nuevo_numero = chr(numero_de_letra + ord("a"))
...
def descifrar(texto_cifrado, desplazamiento):
    ...
    for letra in texto_cifrado:
        if letra != " ":
            numero_de_letra = ord(letra) - ord("a")
            numero_de_letra = (numero_de_letra - desplazamiento) % 26
            letra_de_numero = chr(numero_de_letra + ord("a"))
